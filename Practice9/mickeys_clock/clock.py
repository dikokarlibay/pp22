...
sec = pg.image.load('/Users/diyarkarlibay/Downloads/leftarm.png').convert_alpha()
minute = pg.image.load('/Users/diyarkarlibay/Downloads/rightarm.png').convert_alpha()
rectsec = sec.get_rect()
rectmin = minute.get_rect()
rectmin.center = rectsec.center = midle

background = pg.image.load('/Users/diyarkarlibay/Downloads/mainclock.png').convert_alpha()
run =True
